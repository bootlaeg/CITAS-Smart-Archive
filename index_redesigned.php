...
<section class="hero">
    <div class="hero-content">
        ...
        <div class="hero-stats">
            ...
            <div class="hero-stat"><span class="number">24/7</span><span class="label">Access</span></div>
        </div>
    </div>
</section>
    ...
    <div class="auth-modal-content">
        ...
        <div id="login-tab" class="auth-tab-content" style="display:block;">
            ...
            <form id="loginForm" onsubmit="handleLoginSubmit(event)">
                <div class="auth-form-group"><label for="loginStudentID">Account ID / Credential</label><input type="text" id="loginStudentID" name="student_id" placeholder="Enter Your ID" required></div>
                <div class="auth-form-group"><label for="loginPassword">Password</label><input type="password" id="loginPassword" name="password" placeholder="••••••••" required></div>
        ...
        <div id="signup-tab" class="auth-tab-content" style="display:none;">
            ...
            <form id="signupForm" onsubmit="handleSignupSubmit(event)" enctype="multipart/form-data">
                <div class="row g-2">
                    ...
                    <div class="col-md-6"><div class="auth-form-group"><label for="signupStudentID" id="signupCredentialLabel">Student ID</label><input type="text" id="signupStudentID" name="student_id" placeholder="Enter Student ID" required></div></div>
                    <div class="col-md-6" id="signupAddressGroup"><div class="auth-form-group"><label for="signupAddress">Address</label><input type="text" id="signupAddress" name="address" placeholder="Enter Full Address" required></div></div>
                    <div class="col-md-6" id="signupContactGroup"><div class="auth-form-group"><label for="signupContact">Contact Number</label><input type="tel" id="signupContact" name="contact_number" placeholder="Enter Contact Number" required></div></div>
                    <div class="col-md-6" id="signupCourseGroup"><div class="auth-form-group"><label for="signupCourse">Course</label><select id="signupCourse" name="course" required><option value="">Select Course</option><option value="BSIT">Bachelor of Science in Information Technology</option><option value="BMA">Bachelor of Multimedia Arts</option></select></div></div>
                    <div class="col-md-6" id="signupYearGroup"><div class="auth-form-group"><label for="signupYear">Year Level</label><select id="signupYear" name="year_level" required><option value="">Select Year</option><option value="1st Year">1st Year</option><option value="2nd Year">2nd Year</option><option value="3rd Year">3rd Year</option><option value="4th Year">4th Year</option></select></div></div>
                    <div class="col-md-6"><div class="auth-form-group"><label for="signupPassword">Password</label><input type="password" id="signupPassword" name="password" placeholder="Create Password" required></div></div>
                    <div class="col-md-6"><div class="auth-form-group"><label for="signupConfirmPassword">Confirm Password</label><input type="password" id="signupConfirmPassword" name="confirm_password" placeholder="Confirm Password" required></div></div>
